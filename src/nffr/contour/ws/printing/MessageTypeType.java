...
public class MessageTypeType implements java.io.Serializable {
    ...
    // Constructor
    protected MessageTypeType(java.lang.String value) {
        _value_ = value;
    ...
    public static final MessageTypeType D = new MessageTypeType(_D);
    public static final MessageTypeType F = new MessageTypeType(_F);
    public static final MessageTypeType E = new MessageTypeType(_E);
    public java.lang.String getValue() { return _value_;}
    public static MessageTypeType fromValue(java.lang.String value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:printing.ws.contour.nffr/0.2.2", "MessageTypeType"));
    }
    /**
